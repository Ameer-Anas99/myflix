          ...
          Positioned(
            ...
            child: Column(
              children: [
                ...
                spacingHeight(5),
                splashTexts(
                    text: 'Dive into a world of cinematic wonders',
                    fontSize: 15),
                splashTexts(
                    text: 'Explore, Discover, and Experience the',
                    fontSize: 13),
                splashTexts(text: 'magic of movies with our app', fontSize: 13),
                splashTexts(
                    text: 'Your gateway to a reel adventure awaits!',
                    fontSize: 13),
                spacingHeight(25),
                Container(
                  width: 200,
                  ...
                  child: Padding(
                    ...
                    child: InkWell(
                      child: Container(
                        decoration: BoxDecoration(
                          borderRadius: BorderRadius.circular(20),
                          color: const Color.fromARGB(255, 2, 6, 48)
                              .withOpacity(0.8),
                        ),
                        child: Center(
                          child: splashTexts(text: 'Lets Start', fontSize: 15),
                        ),
                      ),
                      onTap: () {
